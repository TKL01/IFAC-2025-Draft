...
Completed experiments indicate that  the second and fourth joint exhibit the highest temperature increases. Collected datasets are freely available on our streamlit web app.\footnote{https://irolab-fra-uas.streamlit.app/}
